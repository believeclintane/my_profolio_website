        ...
        <div className="w-full md:w-1/2 relative">
          <div className="aspect-square bg-surface-container rounded-lg overflow-hidden border border-outline-variant/10">
            <img
              ...
              data-alt="Technical setup with mechanical keyboard and multiple screens showing lines of backend code in a dark minimalist room"
          ...
          <div className="absolute -bottom-6 -right-6 glass-panel p-6 border border-outline-variant/20 rounded-lg max-w-xs">
